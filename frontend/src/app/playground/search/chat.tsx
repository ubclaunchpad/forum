    ...
    sources_used: [
      {
        ...
        page_number: 46,
        file_url:
          "https://ejemblzcjdswipxsfire.supabase.co/storage/v1/object/public/course-files/documents/Frst_303_Lecture_6_2023",
        relevance: 0.457,
        content:
          "Internal Shoot Anatomy Pith - functions as a storage tissue in the young seedling (not found in the root) epidermis phloem. nerf vascular bundle",
      ...
      },
      {
        ...
        relevance: 0.434,
        content:
          "Primary Growth primary phloem - for transport of food and other biochemicals (e.g., phytohormones) vascular cambium – layer of cells found in between the xylem and phloem, inside the endodermis and pericycle It eventually expands and becomes the meristem that will produce wood",
      ...
      },
      {
        ...
        relevance: 0.434,
        content:
          "Primary Growth Pericycle - similar to cortex in appearance Cell layer from which root branches originate Where certain pericycle cells later become meristematic form new apical meristems and root caps and produce lateral roots that will push their way out into the soil",
        has_image_content: false,
      },
      {
        document_title: "Frst 303 Lecture 6 2023",
        ...
        relevance: 0.417,
        content:
          "Primary Growth Root cross section - from the outside in, the primary tissue zone, i.e., the finished, final tissues after differentiation epidermis Cor Tex endocterm is periey cle FP sale _ prumary phloem vaseudar Cammbiaan",
        has_image_content: true,
      },
      {
        document_title: "Frst 303 Lecture 6 2023",
        ...
        relevance: 0.405,
        content:
          "Secondary Growth of Roots The cortex and endodermis are shed early  they split off as the root expands within The primary phloem gets pushed outwards and is crushed Outer portions of the pericycle, underneath the endodermis, also become meristematic and form a cork cambium which produces the periderm Like shoots, roots with periderms must have lenticels to allow gas movement",
        has_image_content: false,
      },
    ],
  },
...
export default function Component({
  ...
  setDocLink: (link: string, pageNumber: number) => void;
}) {
                ...
                {result.sources_used.map((source, index) => (
                  <li key={index} className="text-sm py-2 border-b">
                    <Button
                      variant={"ghost"}
                      onClick={() =>
                        setDocLink(source.file_url, source.page_number)
                      }
                    ...
                    >
                      ...
                      <span>
                        {" "}
                        (Slide {source.slide_number}, Page {source.page_number})
                      </span>
                    </Button>
