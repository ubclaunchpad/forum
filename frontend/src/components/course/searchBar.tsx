  ...
  return (
    <>
      ...
      <dialog className="bg-transparent top-0" id="dialog">
        <section
          className={`top-10 left-0 flex flex-col max-w-4xl gap-2 w-full rounded-lg  min-w-[1000px] flex-shrink-0 py-2  max-h-[90dvh] overflow-hidden bg-white  border-neutral-100 ${
            response || isLoading ? "rounded-lg" : "rounded-lg"
          }`}
        >
