...
def upgrade() -> None:
   ...
   for i in range(1, 18):
       ...
       """)
   op.execute("ALTER TABLE public.user_courses DROP CONSTRAINT IF EXISTS user_courses_course_id_fkey")
   ...
   for i in range(1, 18):
       ...
       """)
   op.execute("ALTER TABLE public.user_courses DROP CONSTRAINT IF EXISTS user_courses_user_id_fkey")
...
def downgrade() -> None:
   ...
   op.drop_constraint('user_courses_course_id_fkey', 'user_courses', type_='foreignkey', schema='public')
   op.drop_constraint('user_courses_user_id_fkey', 'user_courses', type_='foreignkey', schema='public')