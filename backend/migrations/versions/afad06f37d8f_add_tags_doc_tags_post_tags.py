...
down_revision: Union[str, None] = "7a062c24ebe7"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["course_id"], ["public.courses.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["created_by"], ["auth.users.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(
            ["parent_tag_id"], ["public.tags.id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["created_by"], ["auth.users.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(
            ["doc_id"], ["public.documents.id"], ondelete="CASCADE"
        ),
