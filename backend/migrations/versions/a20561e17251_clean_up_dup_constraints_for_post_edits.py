...
def upgrade() -> None:
   ...
   for i in range(1, 16):
       ...
       """)
   op.execute("ALTER TABLE public.post_edits DROP CONSTRAINT IF EXISTS post_edits_edited_by_fkey")
...
def downgrade() -> None:
   ...
   op.drop_constraint('post_edits_post_id_fkey', 'post_edits', type_='foreignkey', schema='public')
   op.drop_constraint('post_edits_edited_by_fkey', 'post_edits', type_='foreignkey', schema='public')