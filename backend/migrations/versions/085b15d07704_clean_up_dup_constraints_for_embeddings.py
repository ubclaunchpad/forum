...
def upgrade() -> None:
    ...
    op.execute("ALTER TABLE public.embeddings DROP CONSTRAINT IF EXISTS embeddings_parent_chunk_id_fkey1")
    op.execute("ALTER TABLE public.embeddings DROP CONSTRAINT IF EXISTS embeddings_parent_chunk_id_fkey")
...
def downgrade() -> None:
    ...
    op.drop_constraint('embeddings_parent_chunk_id_fkey', 'embeddings', type_='foreignkey', schema='public')