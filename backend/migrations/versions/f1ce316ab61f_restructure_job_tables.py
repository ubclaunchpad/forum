...
def upgrade() -> None:
    ...
    op.add_column('job', sa.Column('specification_id', postgresql.UUID(), nullable=True), schema='public')
    ...
    op.alter_column('job', 'specification_id',
                   nullable=False,
                   schema='public')
    ...
    op.drop_constraint('job_specification_job_id_fkey', 'job_specification', schema='public', type_='foreignkey')
...
def downgrade() -> None:
    ...
    op.drop_constraint('job_specification_id_fkey', 'job', schema='public', type_='foreignkey')
    
    # Add back the old columns as nullable first
    op.add_column('job_specification', sa.Column('cleanup_action', sa.Text(), nullable=True), schema='public')
    op.add_column('job_specification', sa.Column('job_id', postgresql.UUID(), nullable=True), schema='public')
    ...
    op.alter_column('job_specification', 'job_id',
                   nullable=False,
                   schema='public')
