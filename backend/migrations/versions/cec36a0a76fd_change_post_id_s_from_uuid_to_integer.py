...
def upgrade() -> None:
    ...
    op.add_column('posts', sa.Column('id_temp', sa.Integer(), autoincrement=True, nullable=True))
    op.add_column('post_edits', sa.Column("post_id_int", sa.Integer(), nullable=True))
    op.add_column('user_post_events', sa.Column("post_id_int", sa.Integer(), nullable=True))
    ...
    op.alter_column('post_edits', 'post_id_int', new_column_name='post_id', nullable=False)
    op.alter_column('user_post_events', 'post_id_int', new_column_name='post_id', nullable=False)
...
def downgrade() -> None:
    ...
    op.add_column('posts', sa.Column('id', sa.UUID(), nullable=False, server_default=sa.text('gen_random_uuid()')))
