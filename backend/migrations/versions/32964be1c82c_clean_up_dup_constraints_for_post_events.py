...
def upgrade() -> None:
   ...
   for i in range(1, 16):
       ...
       """)
   op.execute("ALTER TABLE public.user_post_events DROP CONSTRAINT IF EXISTS user_post_events_user_id_fkey")
...
def downgrade() -> None:
   ...
   op.drop_constraint('user_post_events_post_id_fkey', 'user_post_events', type_='foreignkey', schema='public')
   op.drop_constraint('user_post_events_user_id_fkey', 'user_post_events', type_='foreignkey', schema='public')
