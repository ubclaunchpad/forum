...
from models.schemas.course_schema import (CourseMembersResponse, CourseResponse, CreateCourseReq,
                                   CreateCourseResponse, GetCoursesResponse)
...
async def unregister_user(c_id: str, u_id: str):
    ...
    if not res:
        raise HTTPException(status_code=400, detail="Failed to unregister user from course")
