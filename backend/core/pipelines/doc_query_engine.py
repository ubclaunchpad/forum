...
class DocumentQueryEngine:
    ...
    def _find_relevant_chunks(self, question_embedding: List[float], threshold: float = 0.0) -> List[Dict]:
        """
    ...
    def _build_prompt(self, question: str, contexts: List[Dict], template_name: Optional[str] = None) -> str:
        """
    ...
    def query(self, question: str, template_name: Optional[str] = None) -> Dict:
        ...
        try:
            ...
            return self._format_response(response.choices[0].message.content, relevant_chunks)
