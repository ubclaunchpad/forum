...
documents = [
    {
        ...
        "content": """Python is a high-level programming language. It emphasizes code readability with its notable use of significant indentation. Python's dynamic typing and dynamic binding make it attractive for rapid application development.""",
    ...
    },
    {
        ...
        "content": """Data structures are ways of organizing and storing data. Common data structures include arrays, linked lists, and trees. Each structure has its own advantages and use cases.""",
        "type": "lecture_notes",
        "metadata": {
